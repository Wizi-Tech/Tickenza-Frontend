...
const signupSchema = z
  .object({
    name: z
      ...
      .regex(/^[A-Z][a-z]*(\s[A-Z][a-z]*)*$/, "First letter capital & only alphabets allowed"),
    email: z
      .string()
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm px-3 sm:px-6">
        <div className="relative bg-white rounded-2xl shadow-lg w-full max-w-md sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-md p-5 sm:p-6 md:p-7">
          {/* Close Button */}
          <button
            onClick={() => router.push("/")}
